package com.senla;
//не знаю, что в этот раз получится
...
public class Hotel {
    ...
    public static void main(String[] args) {
       ...
       // System.out.println(guestDao.getAll());
        ...
        //System.out.println("Введите номер для сортировки ");
        //System.out.println(guestDao.sortedAs());

       // System.out.println(  );

        //roomDao.showAll();
        //System.out.println();
        //System.out.println(roomDao.getAllFree());

        System.out.println("Свободных номеров: " + roomDao.howMuchFreeRoom());
        //System.out.println(orderDao.showAllFree());
