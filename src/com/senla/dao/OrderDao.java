...
//
    ...
    public List <Room> showAllFree(){
            ...
            for (int i = 0; i < orderList.size(); i++) {
                ...
                if (freeTo.isAfter(orderList.get(i).getDateCheckIn().plusDays(orderList.get(i).howDays()))) {
                }
            }
        ...
        public Double howMuchMoney () {
            ...
            for (int i = 0; i < orderList.size(); i++) {
                if (orderList.get(i).getGuest().getId().equals(changeGuest.getId())) {
                    Double totalCost = orderList.get(i).getRoom().getPriceRoom() * orderList.get(i).howDays();
